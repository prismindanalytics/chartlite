...
class NumberWordParserTest {
    ...
    fun `handles no age in transcript`() {
        ...
        // May return null or result without age
        if (result != null) {
            // Age might be null or 0
            assertTrue("No age mentioned - should be null or 0", result.age == null || result.age == 0)
        }
    }
    ...
    fun `rejects unreasonable age`() {
        ...
        if (result != null && result.age != null) {
            assertTrue("200 should not be accepted as age", result.age!! < 150)
        }
    }
    ...
    fun `extracts child age in months`() {
        ...
        // Depending on implementation, this might return age=0 or age=1
